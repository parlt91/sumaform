...
locals {
  ...
  image_urls = {
    ...
    sles15sp4o      = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.suse.de"}/install/SLE-15-SP4-JeOS-Alpha-202111-1/SLES15-SP4-JeOS.x86_64-15.4-OpenStack-Cloud-Alpha-202111-1.qcow2"
